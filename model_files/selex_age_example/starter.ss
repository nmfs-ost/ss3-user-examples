...
selex_age_example_data.ss
selex_age_example_control.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1999
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2013
...
<<<<<<< HEAD
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1698764950
=======
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1698772555
