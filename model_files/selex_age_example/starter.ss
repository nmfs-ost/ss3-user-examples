...
-1 # min year for sdreport outputs (-1 for styr); #_1999
-2 # max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2013
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1744916070
