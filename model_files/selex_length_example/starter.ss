...
selex_length_example_data.ss #_datfile
selex_length_example_control.ss #_ctlfile
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1758551511
