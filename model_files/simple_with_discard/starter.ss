...
4 #_parmtrace:  write parm values to ParmTrace.sso:  0 (no); 1 (good_iter,active_parms); 2 (good,all); 3 (every,all); 4 (every,active)
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1758551663
