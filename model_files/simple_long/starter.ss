...
#C file write time: 2021-11-01 09:22:43
data.ss #_datfile
control.ss #_ctlfile
...
-2 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2031
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1757602357
