...
![selectivity at length and age as estimated in the 'selex_length_example' and 'selex_age_example' models](https://github.com/nmfs-stock-synthesis/user-examples/tree/main/figures/selex_shapes.png?raw=true)
...
![uncertainty in selectivity at length as estimated in the 'selex_length_example' models](https://github.com/nmfs-stock-synthesis/user-examples/tree/main/figures/selex_length_uncertainty.png?raw=true)
